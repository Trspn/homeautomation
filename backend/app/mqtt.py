...
class MQTT:
    ...
    sub_topics = [("620161521_pub", 0), ("620161521", 0), ("620161521_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620161521", self.update)
        self.client.message_callback_add("620161521_pub", self.toggle)
